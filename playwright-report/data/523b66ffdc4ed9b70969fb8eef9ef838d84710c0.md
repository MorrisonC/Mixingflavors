...
- Name: graphics.spec.js >> Graphics QA - Visual Regression >> Main Menu Snapshot - Desktop
- Location: tests\playwright\graphics.spec.js:75:5

# Error details

```
Error: A snapshot doesn't exist at C:\Development\Mixingflavors\tests\playwright\graphics.spec.js-snapshots\main-menu-desktop-chromium-win32.png, writing actual.
```
