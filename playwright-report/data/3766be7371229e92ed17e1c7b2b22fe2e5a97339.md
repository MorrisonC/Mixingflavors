...
- Name: graphics.spec.js >> Graphics QA - Visual Regression >> Gameplay View Snapshot - Mobile
- Location: tests\playwright\graphics.spec.js:111:5

# Error details

```
Error: A snapshot doesn't exist at C:\Development\Mixingflavors\tests\playwright\graphics.spec.js-snapshots\gameplay-view-mobile-chromium-win32.png, writing actual.
```
