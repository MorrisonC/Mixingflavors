...
func before_each():
	...
	grid_manager.grid_size = Vector3i(2, 2, 2)
...
func test_undo_multiple_moves():
	...
	assert_eq(grid_manager.blocks[pos1].current_state, 2, "Block 1 should be destroyed") # 2 = DESTROYED
	...
	assert_eq(grid_manager.blocks[pos1].current_state, 2, "Block 1 should still be destroyed")
