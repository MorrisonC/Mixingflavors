...
- Name: graphics.spec.js >> Graphics QA - Visual Regression >> Level Select Snapshot - Desktop
- Location: tests\playwright\graphics.spec.js:93:5

# Error details

```
Error: A snapshot doesn't exist at C:\Development\Mixingflavors\tests\playwright\graphics.spec.js-snapshots\level-select-desktop-chromium-win32.png, writing actual.
```
